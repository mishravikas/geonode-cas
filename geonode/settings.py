...
CAS_COMPLETELY_LOGOUT = False

CAS_USER_CREATE_CALLBACK = 'foo.cas_callbacks.user_create_callback'
...
AUTHENTICATION_BACKENDS = ('cas_consumer.backends.CASBackend','geonode.security.auth.GranularBackend',)
